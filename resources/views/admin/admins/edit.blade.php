        ...
        <div class="card-body">
            <form action="{{ route('admin.admin.update' , $admin) }}" method="post">
                ...
                <x-adminlte-input name="email" type="email" label="email" placeholder="email"
                    label-class="text-lightblue" value="{{ old('email' , $admin->email) }}">
                </x-adminlte-input>
            ...
            <form action="{{ route('admin.admin.destroy' , $admin) }}" method="post">
                @csrf
                @method('delete')
                <x-adminlte-button label="Danger" type="submit" label="Delete Admin" theme="danger" icon="far fa-trash-alt" />
            </form>
        </div>
    </div>
</div>
